...
public class Winner {
    ...
    public static final List<Winner> tdfWinners = Arrays.asList(
            ...
            new Winner(2017, "Great Britain", "Chris Froome", "Team Sky", 3520, Duration.parse("PT89H04M48S"), 14),
            new Winner(2018, "Great Britain", "Geraint Thomas", "Team Sky", 3351, Duration.parse("PT89H04M48S"), 14),
            new Winner(2019, "Colombia", "Egan Bernal", "Team Sky", 3481, Duration.parse("PT89H04M48S"), 14),
            new Winner(2020, "Slovenia", "Tadej Pogacar", "Team Sky", 3484, Duration.parse("PT89H04M48S"), 14),
            new Winner(2021, "Slovenia", "Tadej Pogacar", "Team Sky", 3417, Duration.parse("PT89H04M48S"), 14),
            new Winner(2022, "Denmark", "Jonas Vingegaard", "Team Sky", 3350, Duration.parse("PT89H04M48S"), 14));
}
